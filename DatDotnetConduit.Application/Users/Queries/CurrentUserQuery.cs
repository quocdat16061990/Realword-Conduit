...
namespace DatDotnetConduit.Application.Users.Queries
{
    ...
    internal class CurrentUserQueryHandle : IRequestHandler<CurrentUserQuery, UserDto>
    {
        private readonly MainDbContext _mainDbContext;
        private readonly ICurrentUser _currentUser;
        public CurrentUserQueryHandle(MainDbContext mainDbContext, ICurrentUser currentUser)
        {
